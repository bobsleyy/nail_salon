...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('nail_salon_app', '0004_delete_beforemade_remove_costandtime_service_type_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_cost', models.DecimalField(decimal_places=2, max_digits=5)),
            ],
        ),
        migrations.CreateModel(
            name='Photos',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('what_to_do', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nail_salon_app.service')),
            ],
        ),
        migrations.AddField(
            model_name='service',
