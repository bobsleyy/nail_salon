...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('nail_salon_app', '0004_remove_costandtime_addon_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('addon', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nail_salon_app.addons')),
                ('before_made_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nail_salon_app.beforemadeby')),
            ],
        ),
        migrations.CreateModel(
            name='Photos',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_types', models.ManyToManyField(related_name='types', through='nail_salon_app.CostAndTime', to='nail_salon_app.servicetype')),
            ],
        ),
        migrations.AddField(
